...
public class Robot extends Entity{
	 ...
	 * 
	 * @post	De ori�ntatie van de robot is gelijk aan de gegeven parameter.
	 ...
	 * 			|super.toString() + ", energie: " + getEnergy().toString() + ", ori�ntatie: " + getOrientation().toString() + ", gewicht: " + getTotalWeight().toString()
	 * 
	 * @see		roborally.model.Entity#toString()
	 */
	@Override
	public String toString() {
		return super.toString() + ", energie: " + getEnergy().toString() + ", maximale energie: " + getMaxEnergy().toString() + ", ori�ntatie: " + getOrientation().toString() + ", gewicht: " + getTotalWeight().toString();
	}
